...
import {
  Animated, View, Easing as RNEasing, StyleSheet,
} from 'react-native';
...
class Bubble extends React.Component<Props, State> {
  ...
  handleStartShouldSetResponder = ({ nativeEvent }: *) => this.isTouchWithinHitCircle(nativeEvent.locationX, nativeEvent.locationY);
  ...
  render() {
    ...
    const {
      ...
      children, initialPosition, onPress, ...rest
    } = this.props;
